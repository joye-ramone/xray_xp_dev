#pragma once
// ==================================== Правки от alpet ======================================= 
#define HLAMP_AFFECT_IMMUNITIES			// включает обработку иммунитетов для лампочек
...
#define USE_LAST_SAVE_VS_QUICK			// включает загрузку последнего сейва, вместо _quicksave по нажатию F8 или другой назначенной кнопке
