...
#define WIND_RADIUS (4*Radius())	//рассто€ние до актера, когда по€вл€етс€ ветер 
...
//////////////////////////////////////////////////////////////////////////
	...
	//загрузить параметры дл€ разбрасывани€ артефактов
...
void CCustomZone::shedule_Update(u32 dt)
{
	...
	if (IsEnabled())
	{
			...
			m_ObjectInfoMap.end() != it; ++it) 
		{
			...
			//если есть хот€ бы один не дисабленый объект, то
			//зона считаетс€ активной
...
void CCustomZone::SetMaxPower(float p)
{
	m_fMaxPower = p;	
#ifdef LUAICP_COMPAT
	// сохранение значени€ в серверном объекте
...
{
	//вычислить согласно распределению веро€тностей
