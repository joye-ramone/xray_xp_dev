...
protected:
	...
	Root		DATA;
	BOOL		bReadOnly;
	SMap		smIncludeMacro;      // alpet: макросы дл€ подстановки в include
...
public:
	...
	LPCSTR 		r_string		( LPCSTR S, LPCSTR L);															// оставл€ет кавычки
	LPCSTR 		r_string		( const shared_str& S, LPCSTR L)				{ return r_string(*S,L);		}	// оставл€ет кавычки
