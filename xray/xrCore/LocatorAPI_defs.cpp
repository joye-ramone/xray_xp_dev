...
// FS_File
//////////////////////////////////////////////////////////////////////
FS_File::FS_File(xr_string nm, u64 sz, time_t modif,unsigned attr)	{set(nm,sz,modif,attr);}
...
void FS_File::set(xr_string nm, file_size sz, time_t modif,unsigned attr)
{
